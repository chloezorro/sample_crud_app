...
<body>
  ...
  <div class="section no-pad-bot" id="index-banner">
    <div class="container">
    <h3 class="header center orange-text">Edit Section</h3>
      <br><br>
  ...
  <div class="input-field col s6">
      <input value="<?php echo e($post->previous_job); ?>" id="previous_job" type="text" class="validate" placeholder="Previous Job" name="previous_job">
  ...
  <form action="/posts/<?php echo e($post->id); ?>">

<?php echo csrf_field(); ?>
<?php echo method_field('delete'); ?>

<button class="btn waves-effect waves-light" name="delete">Delete
</button>
</form>
    </form>
...
<?php /**PATH C:\xampp\htdocs\laravel\simple_crud\resources\views/posts/edit.blade.php ENDPATH**/ ?>